function IRCE_Plotting_mean_ResponseSignal_sorted_withLocalizationFilter(Stats_ROIs, fig_color, inclusion_idx, idx_map_to_time_idx)
%
...
% cells* its the mean intensity of cells with signal.
    ...
    hold on
        ...
        x = x(idx_map_to_time_idx); % Pull out response timepoints
