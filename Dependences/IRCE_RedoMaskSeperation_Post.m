function Base_label_ROIs_Post = IRCE_RedoMaskSeperation_Post(Specific_ROIs, roi_corners, Ch1_corr_IRM, IRM_thres, IRM_LUT, Save_individual_acq_dir)
    ...
    if exist('Base_label_ROIs_Post.mat', 'file')
        ...
        error('You need to generate base labels before you edit one.')
    end
