function [no_output_gen_video] = IRCE_FinalMaskVideo_IRMoverlay(Save_individual_acq_dir, Specific_ROIs, Dilated_label_ROIs, filtered_IRM_data, IRM_LUT, roi_corners)
