function [no_output_gen_video] = IRCE_FinalMaskVideo_Post(Save_individual_acq_dir, Specific_ROIs, Dilated_label_ROIs)
...
%---------------------------------------------------------%
cd(Save_individual_acq_dir)
    folderName = 'Label_Videos_Post_PostManual_Edits'; % Generate a folder name for this data set
    ...
    while  n <= width(Specific_ROIs)
        ...
        img_name = ['Label_Img_Post_PostManual_Edits_ROI_' num2str(i,'%03.f')];
