function [no_output_gen_video] = IRCE_gen_2ch_movie(Dilated_label_forROIs, Ch1_corr_IRM, IRM_LUT, Ch3_Response, Response_LUT, Time_stamps_address, Video_Name, ROI_n,channel_labels, roi_IRM_interface)
